...
- review-candidate notes, if a frozen external review target exists, such as `docs/release/v0-review-candidate-2026-05-18-r3.md`;
- superseded review-candidate notes, if a target was updated before review, such as `docs/release/v0-review-candidate-2026-05-18-r2.md`;
