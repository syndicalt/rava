...
The external review execution plan is [security/review-plan-v0.md](security/review-plan-v0.md) (`docs/security/review-plan-v0.md`), kickoff checklist is [security/external-review-kickoff-checklist-v0.md](security/external-review-kickoff-checklist-v0.md) (`docs/security/external-review-kickoff-checklist-v0.md`), and optional longer fuzz campaigns should use [security/fuzz-campaigns/template-v0.md](security/fuzz-campaigns/template-v0.md) (`docs/security/fuzz-campaigns/template-v0.md`).
