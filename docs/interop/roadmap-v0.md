...
MCP adapter guidance is documented in [mcp-adapter-v0.md](mcp-adapter-v0.md).
OAuth exchange guidance is documented in [oauth-exchange-v0.md](oauth-exchange-v0.md).
...
5. Keep MCP adapter proof-of-concept guidance verification-first.
6. Keep OAuth exchange examples subordinate to verified Rava action context.
