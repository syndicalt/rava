...
fn v1_preview_migration_notes_cover_preview_surface_changes() -> Result<(), Box<dyn Error>> {
    ...
    for required in [
        ...
        "--trust-bundle",
        "rava-static-trust-bundle-v0",
        "does not add dynamic resolver freshness",
        "fresh_until_unix",
    ...
    let runbooks: [(&str, &[&str]); 5] = [
        ...
        (
            ...
            &[
                ...
                "They do not provide dynamic DID, web, registry, resolver freshness, cache invalidation, rotation, rollback, or outage guarantees.",
                "rollback",
            ],
        ),
        (
